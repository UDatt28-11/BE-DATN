...
class InvoiceItemController extends Controller
{
    ...
    public function index(Request $request, string $invoiceId): JsonResponse
    {
        ...
        return response()->json([
            ...
            Log::error('InvoiceItemController@index failed', [
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi lấy danh sách hạng mục hóa đơn.',
            ], 500);
        }
    }
    ...
    public function addPenaltyItem(Request $request, string $invoiceId): JsonResponse
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('InvoiceItemController@addPenaltyItem failed', [
                'invoice_id' => $invoiceId,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi thêm phí phát sinh.',
            ], 500);
        }
    }
    ...
    public function addRegularItem(Request $request, string $invoiceId): JsonResponse
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('InvoiceItemController@addRegularItem failed', [
                'invoice_id' => $invoiceId,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi thêm hạng mục.',
            ], 500);
        }
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('InvoiceItemController@store failed', [
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString(),
    ...
    public function bulkCreate(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Đã tạo ' . count($created) . ' hạng mục thành công',
                'data' => $created
            ], 201);
        } catch (\Illuminate\Validation\ValidationException $e) {
            DB::rollBack();
            ...
            DB::rollBack();
            Log::error('InvoiceItemController@bulkCreate failed', [
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi tạo hàng loạt hạng mục.',
            ], 500);
        }
    }
    ...
    public function bulkDelete(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Đã xóa ' . count($items) . ' hạng mục thành công.'
            ]);
        } catch (\Illuminate\Validation\ValidationException $e) {
            DB::rollBack();
            return response()->json([
            ...
            DB::rollBack();
            Log::error('InvoiceItemController@bulkDelete failed', [
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi xóa hàng loạt hạng mục.',
            ], 500);
        }
    }
    ...
    public function show(string $id): JsonResponse
    {
        try {
            ...
            $item = InvoiceItem::with('invoice:id,booking_order_id,total_amount,status')->findOrFail($id);
            ...
            Log::error('InvoiceItemController@show failed', [
                'item_id' => $id,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi lấy thông tin hạng mục.',
            ], 500);
        }
    }
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Hạng mục hóa đơn đã được cập nhật',
                'data' => $item
            ]);
        } catch (\Illuminate\Validation\ValidationException $e) {
            DB::rollBack();
            ...
            DB::rollBack();
            Log::error('InvoiceItemController@update failed', [
                'item_id' => $id,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi cập nhật hạng mục.',
            ], 500);
        }
    }
    ...
    public function destroy(string $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Hạng mục hóa đơn đã được xóa thành công.'
            ]);
        } catch (\Illuminate\Database\Eloquent\ModelNotFoundException $e) {
            DB::rollBack();
            return response()->json([
            ...
            DB::rollBack();
            Log::error('InvoiceItemController@destroy failed', [
                'item_id' => $id,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi xóa hạng mục.',
            ], 500);
        }
    }
    ...
    public function getPenaltyItems(string $invoiceId): JsonResponse
    {
        ...
        return response()->json([
            ...
            Log::error('InvoiceItemController@getPenaltyItems failed', [
                'invoice_id' => $invoiceId,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi lấy danh sách phí phát sinh.',
            ], 500);
        }
    }
    ...
    public function getRegularItems(string $invoiceId): JsonResponse
    {
        ...
        return response()->json([
            ...
            Log::error('InvoiceItemController@getRegularItems failed', [
                'invoice_id' => $invoiceId,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi lấy danh sách hạng mục thường.',
            ], 500);
        }
    }
}
