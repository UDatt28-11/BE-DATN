...
class SupplyController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('SupplyController@store failed', [
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi tạo vật tư.',
            ], 500);
        }
    }
    ...
    public function show(string $id): JsonResponse
    {
        ...
        return response()->json([
            ...
            Log::error('SupplyController@show failed', [
                'supply_id' => $id,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi lấy thông tin vật tư.',
            ], 500);
        }
    }
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        return response()->json([
            ...
            Log::error('SupplyController@update failed', [
                'supply_id' => $id,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi cập nhật vật tư.',
            ], 500);
        }
    }
    ...
    public function destroy(string $id): JsonResponse
    {
        ...
        return response()->json([
            ...
            Log::error('SupplyController@destroy failed', [
                'supply_id' => $id,
                'message' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi xóa vật tư.',
            ], 500);
        }
    }
     ...
     *
     * @OA\Get(
     *     path="/api/supplies/status/low-stock",
     ...
     *
     * @OA\Get(
     *     path="/api/supplies/status/out-of-stock",
     ...
     *
     * @OA\Patch(
     *     path="/api/supplies/{id}/adjust-stock",
     ...
     *
     * @OA\Get(
     *     path="/api/supplies/statistics/overview",
